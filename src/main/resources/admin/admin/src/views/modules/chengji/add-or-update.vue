    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="kechengId" name="kechengId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩得分" prop="chengjiDefen">
                       <el-input v-model="ruleForm.chengjiDefen"
                                 placeholder="成绩得分" clearable  :readonly="ro.chengjiDefen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="成绩得分" prop="chengjiDefen">
                           <el-input v-model="ruleForm.chengjiDefen"
